...
let game = { score: 0, maxScore: 0, maxTime: 30, elapsedTime: 0, totalSprites: 1, state: GameState.Start, targetSprite: 1 };
...
function draw() {
  switch(game.state) {
    ...
    case GameState.GameOver:
      ...
      textSize(35);
      text("Score: " + game.score,200,230);
      text("Max Score: " + game.maxScore,200,280);
      text("Press Any Key",200,330);
      text("to Play Again",200,370);
      break;
